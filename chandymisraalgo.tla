...
fair process misra \in Node
   ...
   Receiver:  while TRUE do
                    ...
                    parent := m.sendr;
                    handle: multicast(ch,[q \in neighbours(self) |-> [sendr |-> self, d |-> dist]]);
                    else skip;
                    end if;
              end while;
end process;
...
\* BEGIN TRANSLATION - the hash of the PCal code: PCal-c1b566dc3b4cc03732b5cbf9e83c9ec7
...
misra(self) == Sender(self) \/ Receiver(self) \/ handle(self)
...
\* END TRANSLATION - the hash of the generated TLA code (remove to silence divergence warnings): TLA-7734e766f36fbd08aeeca94b795db578
MG == [sendr: Node ,d: Nat]
...
\* Last modified Thu Mar 24 11:45:11 GMT 2022 by zunai
