...
fair process  sub \in Processes \X Processes  
      ...
      L2:  await pc[self[1], 0] = "wait";     
           await choosing[self[2], 0] = FALSE;
...
\* BEGIN TRANSLATION (chksum(pcal) = "e1d09a6f" /\ chksum(tla) = "3109f2fe")
...
MutualExclusion == \A i, j \in Processes : pc[i,0] = "CS" /\ pc[i,j] = "CS" => i=j
StarvationFree == \A i,j \in Processes : []<> (pc[i,0] = "CS" /\ pc[i, j]="CS" =>i=j)
=============================================================================
\* Modification History
\* Last modified Sat Mar 26 14:48:52 GMT 2022 by zunai
\* Created Fri Mar 11 15:41:02 GMT 2022 by zunai
