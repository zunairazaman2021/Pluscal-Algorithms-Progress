...
***)
\* BEGIN TRANSLATION - the hash of the PCal code: PCal-4fcde1f95e26598deccea8300e999477
...
L3(self) == /\ pc[self][3]  = "L3"
            ...
            /\ \E i \in procs3:
                 ...
                 /\ procs3' = procs3 \ {i}
            /\ pc' = [pc EXCEPT ![self][3] = "P2"]
            /\ UNCHANGED << numbers, choosing, procs >>

P2(self) == /\ pc[self][3]  = "P2"
            /\ procs3={}
...
\* END TRANSLATION - the hash of the generated TLA code (remove to silence divergence warnings): TLA-42c8398c0bb8e4f3bacaf1b00c57c57c
...
\* Last modified Tue Mar 29 16:02:31 GMT 2022 by zunai
